from utils import save_debug_json
...
def build_database(debug=False):
    ...
    try:
        ...
        save_debug_json(state_data, './_output/state_data_debug.json')

        # Insert state data into the database
        logger.info("Inserting state data into database...")
        insert_state_data(conn, state_data)
        ...
        save_debug_json(pop_data, './_output/pop_data_debug.json')
